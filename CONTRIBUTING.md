...
example, if `func GetFoo()` function will be deprecated in `v0.45.0` version, it gets the following godoc line:

```go
// Deprecated: [as of v0.45.0] Use func MustGetFoo instead.
func GetFoo() Bar {
```

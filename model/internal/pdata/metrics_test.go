...
func TestOtlpToInternalReadOnly(t *testing.T) {
	...
	assert.EqualValues(t, NewAttributeMapFromMap(map[string]AnyValue{
		"string": NewAnyValueString("string-resource"),
	...
	assert.EqualValues(t, NewAttributeMapFromMap(map[string]AnyValue{"key0": NewAnyValueString("value0")}), gaugeDataPoints.At(0).Attributes())
	// Second point
	...
	assert.EqualValues(t, NewAttributeMapFromMap(map[string]AnyValue{"key1": NewAnyValueString("value1")}), gaugeDataPoints.At(1).Attributes())
	...
	assert.EqualValues(t, NewAttributeMapFromMap(map[string]AnyValue{"key0": NewAnyValueString("value0")}), sumDataPoints.At(0).Attributes())
	// Second point
	...
	assert.EqualValues(t, NewAttributeMapFromMap(map[string]AnyValue{"key1": NewAnyValueString("value1")}), sumDataPoints.At(1).Attributes())
	...
	assert.EqualValues(t, NewAttributeMapFromMap(map[string]AnyValue{"key0": NewAnyValueString("value0")}), histogramDataPoints.At(0).Attributes())
	...
	assert.EqualValues(t, NewAttributeMapFromMap(map[string]AnyValue{"key1": NewAnyValueString("value1")}), histogramDataPoints.At(1).Attributes())
...
func TestOtlpToFromInternalGaugeMutating(t *testing.T) {
	newAttributes := NewAttributeMapFromMap(map[string]AnyValue{"k": NewAnyValueString("v")})
